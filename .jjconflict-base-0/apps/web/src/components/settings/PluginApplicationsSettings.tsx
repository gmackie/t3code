...
export function PluginApplicationsSettingsPanel() {
  ...
  return (
    <SettingsSection title="Plugin applications" icon={<PowerIcon className="size-4" />}>
      <SettingsRow
        title="Installed plugins"
        description="Plugins run as independent applications. Review their requested capabilities before enabling them."
        status={plugins.error ?? (environment ? null : "Connect an environment to manage plugins.")}
      >
        {plugins.isPending ? (
