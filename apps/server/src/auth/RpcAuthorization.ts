...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.pluginList]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginInstall]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginEnable]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginDisable]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginGrant]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginRevoke]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginHealth]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginSurfaceGet]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginPanelGet]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginWorkflowGet]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginWorkflowAction]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginAction]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginSettingsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.pluginSettingsUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.pluginSettingsReset]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerUsageGet]: AuthOrchestrationReadScope,
  [WS_METHODS.providerUsageRefresh]: AuthOrchestrationReadScope,
  [WS_METHODS.providerUsageSubscribe]: AuthOrchestrationReadScope,
