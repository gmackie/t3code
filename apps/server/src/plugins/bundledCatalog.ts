...
export type BundledPlugin = { readonly manifest: PluginManifest; readonly source: PluginPackageSource };
        ...
        "settingsPanels": [
          {
            ...
            "description": "Bob owns Bob, Linear, and KanBanger authentication, polling, and link state.",
            "settingIds": [
              "bob.api-endpoint",
              "bob.api-token",
              "bob.linear-endpoint",
        ...
        "settingsPanels": [
          {
            ...
            "title": "Creator",
            "description": "Connect T3 Code to the Creator OS command center for ideas, production, publishing, analytics, sponsors, and media operations.",
            "settingIds": [
              "creator.workspace",
              "creator.polling-seconds"
            ]
          }
        ],
        "hooks": [
        ...
        "settingsPanels": [
          {
            ...
            "title": "FabForge",
            "description": "A manufacturing IDE for 3D printing, laser/plasma cutting, CNC, materials, machine state, and production evidence.",
            "settingIds": [
              "fabforge.endpoint",
              "fabforge.token",
              "fabforge.workspace",
        ...
        "settingsPanels": [
          {
            ...
            "title": "ForgeGraph",
            "description": "Track PR checks, changesets, deployments, and health from the delivery graph.",
            "settingIds": [
              "forgegraph.endpoint",
              "forgegraph.token",
              "forgegraph.app",
        ...
        "settingsPanels": [
          {
            ...
            "title": "Jujutsu",
            "description": "Observe Jujutsu repositories through a dedicated change graph and operation cockpit.",
            "settingIds": [
              "jujutsu.project-root",
              "jujutsu.polling-seconds"
            ]
          }
        ],
        "hooks": [
