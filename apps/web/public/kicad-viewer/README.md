...
The CAD integration and adapter sources were ported from [T3CAD](https://github.com/i2cjak/T3CAD) commit `bb429b380407f0914e2101daab3d3a6380a3deff` (MIT). T3 Code keeps its own application identity and provides these tools through Code / CAD modes.
