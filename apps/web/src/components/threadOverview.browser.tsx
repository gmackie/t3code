...
import { threadOverviewExtension } from "../extensions/builtins/threadOverview";

describe("threadOverviewExtension", () => {
  afterEach(() => {
    document.body.innerHTML = "";
  });

  it("opens workspace files in the in-app viewer when the latest plan contains a file link", async () => {
    const handleOpenWorkspaceFile = vi.fn();
    const screen = await render(
      threadOverviewExtension.render({
