...
interface PlanSidebarProps {
  ...
  issueContent?: ReactNode | undefined;
  ...
  onClose: () => void;
  onTabChange?: ((tab: "tasks" | "issue") => void) | undefined;
  mode?: "sidebar" | "sheet";
}
...
const PlanSidebar = memo(function PlanSidebar({
  ...
  const hasIssueTab = Boolean(issueContent);
  const selectedTab = hasIssueTab ? activeTab : "tasks";
    ...
    >
      ...
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-border/60 px-3">
        ...
        <div className="flex items-center gap-1">
          {selectedTab === "tasks" && planMarkdown ? (
            <Menu>
              <MenuTrigger
                render={
                  <Button
          ...
          <Button
            ...
            variant="ghost"
            onClick={onClose}
            aria-label={mode === "sidebar" ? "Close right panel" : "Close panel tab"}
            className="text-muted-foreground/50 hover:text-foreground/70"
          >
      ...
      {/* Content */}
      {selectedTab === "issue" && issueContent ? (
        issueContent
      ) : (
