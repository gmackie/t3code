...
>(api: ProjectApi, method: TMethod): api is ProjectApi & Required<Pick<ProjectApi, TMethod>> {
...
export function projectCodeDocumentSymbolsQueryOptions(input: {
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      ...
      const api = resolveProjectApi(input.environmentId ?? null);
      if (!supportsProjectMethod(api, "getDocumentSymbols")) {
        return EMPTY_CODE_DOCUMENT_SYMBOLS_RESULT;
      }
...
export function projectCodeHoverQueryOptions(input: {
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      ...
      const api = resolveProjectApi(input.environmentId ?? null);
      if (!supportsProjectMethod(api, "getHover")) {
        return EMPTY_CODE_HOVER_RESULT;
      }
      return api.getHover({
        cwd: input.cwd,
        relativePath: input.relativePath,
...
export function projectCodeDefinitionsQueryOptions(input: {
  ...
  return queryOptions({
    ...
    queryFn: async () => {
      ...
      const api = resolveProjectApi(input.environmentId ?? null);
      if (!supportsProjectMethod(api, "getDefinitions")) {
        return EMPTY_CODE_DEFINITIONS_RESULT;
      }
