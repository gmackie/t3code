...
export const WORKSPACE_PLAN_TAB_ID = "__workspace_plan__";
export const WORKSPACE_PREVIEW_TAB_ID = "__workspace_preview__";

export type WorkspaceSpecialTabId = typeof WORKSPACE_PLAN_TAB_ID | typeof WORKSPACE_PREVIEW_TAB_ID;

export function isWorkspaceSpecialTabId(tabId: string): tabId is WorkspaceSpecialTabId {
  return tabId === WORKSPACE_PLAN_TAB_ID || tabId === WORKSPACE_PREVIEW_TAB_ID;
}
