...
export const SmolAgentModelOptions = Schema.Struct({});
export type SmolAgentModelOptions = typeof SmolAgentModelOptions.Type;
...
export const ProviderModelOptions = Schema.Struct({
  ...
  smolAgent: Schema.optional(SmolAgentModelOptions),
});
